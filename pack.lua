...
-- Decompiled on 2026-01-18 19:11:39
-- Luau version 6, Types version 3
-- Time taken: 0.124732 seconds
...
local module = {
	["Noobini Pizzanrage = game:GetService("ReplicatedStorage")
local LuckyBlocks = require(ReplicatedStorage:WaitForChild("Datas").LuckyBlocks)
local Updates_upvr = require(ReplicatedStorage:WaitForChild("Shared").Updates)
local module = {
	["Noobini Pizzanini"] = {
...
local function IsEnabled() -- Line 2503
	--[[ Upvalues[1]:
		[1]: Updates_upvr (readonly)
	]]
	return Updates_upvr.Methods.IsEnabled("Update-01/17/2026")
end
tbl.IsEnabled = IsEnabled
module.GOAT = tbl
module["Brunito Marsito"] = {
	DisplayName = "Brunito Marsito";
	Rarity = "Secret";
	Price = 750000000;
	Generation = 3500000;
	IsEnabled = function() -- Line 2513, Named "IsEnabled"
		--[[ Upvalues[1]:
			[1]: Updates_upvr (readonly)
		]]
		return Updates_upvr.Methods.IsEnabled("Update-01/17/2026")
...
module["Premium Festive Lucky Block"] = {
